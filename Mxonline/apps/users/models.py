...
class UserProfile(AbstractUser):
    ...
    birthday = models.DateField(verbose_name=u"生日",default=datetime.now)
...
class EmailVerifyRecord(models.Model):
    ...
    send_type = models.CharField(choices=(("register",u"注册"),("forget",u"忘记密码")),max_length=50,verbose_name=u'验证类型')
